...
export default function Page() {
  ...
  async function checkout() {
    ...
    setMessage("");
    const r = await fetch("/api/orders", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ items: cartItems.map(p => ({ id: p.id, name: p.name, unit: p.unit, price: p.price, qty: p.qty })) }) });
